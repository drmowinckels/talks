...
Also, this workshop has exposed a bug in my package. The checkboxes are not returned in the fashion I wanted and first developed it to. I have made a note of this and will fix it in the next release. Untill then, I'll present you with the solution to working with this bug.
...
???
The checkbox type of "string" is incorrectly returned as a list columns. 
This was not my intention. It should return as a string, where each element chosen 
for the checkboxes are delimited with a `;` by default.
