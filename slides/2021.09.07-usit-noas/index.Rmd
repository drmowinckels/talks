...
For instance, when I started with the data harmonisation, I had at least three main types of data to work with, and a single binary variable like "Sex" I found to be coded in no less than 7 different ways.
...
**Solution:**
- create a system where several historical versions of the derived data exist
